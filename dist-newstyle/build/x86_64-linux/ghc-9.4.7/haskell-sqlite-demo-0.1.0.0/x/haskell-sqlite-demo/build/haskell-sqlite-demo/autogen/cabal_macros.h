...
/* package haskell-sqlite-demo-0.1.0.0 */
#ifndef VERSION_haskell_sqlite_demo
#define VERSION_haskell_sqlite_demo "0.1.0.0"
#endif /* VERSION_haskell_sqlite_demo */
#ifndef MIN_VERSION_haskell_sqlite_demo
#define MIN_VERSION_haskell_sqlite_demo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_sqlite_demo */
...
#define CURRENT_COMPONENT_ID "haskell-sqlite-demo-0.1.0.0-inplace-haskell-sqlite-demo"
